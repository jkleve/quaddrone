...
void imu_init(){
    ...
    // Sample rate divider at 19 => Sample = 1KHz/(1+19) = 50 Hz with 1 KHz sample if DLPF ON
	TWI_Write(MPU6050_RA_SMPLRT_DIV, MPU6050_CLOCK_DIV_296);
	_delay_ms(2);
